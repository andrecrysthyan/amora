...
<div class="col-md-6 col-xs-12">
	...
	<div class="col-md-12 col-xs-12 texto-header-internas " data-aos="fade-right">
		<div class="titulo">
			<h2>Projetos de <span class="negrito">Web Sites</span></h2>
			<p><hr/></p>
		</div>
...
<div class="col-md-12 col-xs-12 retira-padding redes-sociais-servicos-2" data-aos="fade-up"
	...
	<div class="col-md-4 col-xs-12">
		<?php echo $this->Html->image('desenvolvimento-1.jpg', ['title' => 'Nuvem Desenvolvimento Web', 'class' => 'img-responsive img-sobre-internas']) ?>
	</div>
	<div class="col-md-8 col-xs-12 texto-sobre-internas">
		<h2>-Web Sites</h2>
		<p>Layout personalizado de acordo com nosso cliente gerando sites interativos e criativos totalmente compatíveis com computadores, tablets e smartphones. Sites desenvolvidos com um conjunto de técnicas para que o usuário tenha uma maravilhosa experiência no seu site, e melhoria do posicionamento natural nos sites de busca, como Google ou Bing. Inserimos, alteramos e excluimos conteúdo do seu site, fazendo também alterações de estrutura e layout. Para que possamos entregar resultados reais fazemos o monitoramento de tráfego sendo possível descobrir quantos usuários acessam o seu site e de que forma esses usuários se comportar ao navegar pelas diversas páginas e seções.
		</p>
	</div>
</div>
<div class="col-md-12 col-xs-12 redes-sociais-conteudo" data-aos="fade-up"
     data-aos-duration="2000">
	<div class="titulo">
		<h2><span class="negrito">Alguns de nossos Web Sites!</span></h2>
		<p><hr/></p>
	</div>
	...
	<div class="row">
		...
		<?php foreach($clientes2 as $cliente):?>
			<?php if($cliente->tipocategoria == "1" || $cliente->tipocategoria == "3"){ ?>
	...
	<div class="col-md-4 col-xs-12">
		...
		<div class="col-md-12 col-xs-12 cliente-nuvem" data-aos="fade-up"
     data-aos-duration="2000">
